...
generate_agent_script_url() {
    ...
    if [ "$action" == "install" ]; then
        ...
        url="https://github.com/groots-software-technologies/cn_metrics_remote_agent/raw/refs/heads/main/${OS}/${monitor_type}/install/${ARCH}.sh"
    elif [ "$action" == "uninstall" ]; then
        # URL for uninstallation script
        url="https://github.com/groots-software-technologies/cn_metrics_remote_agent/raw/refs/heads/main/${OS}/${monitor_type}/uninstall/${ARCH}.sh"
    else
...
download_and_execute_agent_script() {
    ...
    local script_url
    script_url=$(generate_agent_script_url "$action" "$monitor_type")
